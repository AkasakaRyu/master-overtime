...
<html>
	<head>
		...
		<title>Sistem Overtime - <?= $Title ?></title>
	...
	<body style="background:#dfe6e9" no-repeat center" class="hold-transition login-page">
		<div class="login-box" style="margin:5% auto">
			<div class="login-logo">
				<img src="<?= base_url('assets/images/CVLMJ.png') ?>" width=100><br />
				<span style="font-size:0.8em;">CV LOEN MANDIRI JAYA</span>
				<span style="font-size:0.4em;display:block">
					SISTEM INFORMASI PENENTUAN JAM OVERTIME
				</span>
			</div>
			<?php 
